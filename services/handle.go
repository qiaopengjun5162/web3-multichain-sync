...
import (
	...
	"github.com/qiaopengjun5162/web3-multichain-sync/common/json2"
	"github.com/qiaopengjun5162/web3-multichain-sync/database"
	"github.com/qiaopengjun5162/web3-multichain-sync/database/dynamic"
...
const (
	ChainName      = "Ethereum"
	Network        = "mainnet"
	UnsupprtedType = "Unsupported transaction type"
)

var (
	EthGasLimit   uint64 = 60_000
	TokenGasLimit uint64 = 120_000
	Min1Gwei      uint64 = 1_000_000_000
...
func (bws *BusinessMiddleWireServices) ExportAddressesByPublicKeys(ctx context.Context, request *wallet_go.ExportAddressesRequest) (*wallet_go.ExportAddressesResponse, error) {
	var (
		retAddresses []*wallet_go.Address
	...
	if err != nil {
		return &wallet_go.ExportAddressesResponse{
			Code: wallet_go.ReturnCode_ERROR,
...
func (bws *BusinessMiddleWireServices) CreateUnSignTransaction(ctx context.Context, request *wallet_go.UnSignTransactionRequest) (*wallet_go.UnSignTransactionResponse, error) {
	response := &wallet_go.UnSignTransactionResponse{
		Code:     wallet_go.ReturnCode_ERROR,
		UnSignTx: "0x00",
	}
	...
	unsignedTx := &account.UnSignTransactionRequest{
		Chain:    ChainName,
		Network:  Network,
		Base64Tx: base64Str,
	}

	log.Info("BusinessMiddleWireServices CreateUnSignTransaction unsignedTx", json2.ToJSONString(unsignedTx))
	returnTx, err := bws.accountClient.AccountRpClient.CreateUnSignTransaction(ctx, unsignedTx)
	...
	response.Code = wallet_go.ReturnCode_SUCCESS
...
func (bws *BusinessMiddleWireServices) BuildSignedTransaction(ctx context.Context, request *wallet_go.SignedTransactionRequest) (*wallet_go.SignedTransactionResponse, error) {
	response := &wallet_go.SignedTransactionResponse{
		Code: wallet_go.ReturnCode_ERROR,
	}
...
func (bws *BusinessMiddleWireServices) SetTokenAddress(ctx context.Context, request *wallet_go.SetTokenAddressRequest) (*wallet_go.SetTokenAddressResponse, error) {
	var (
	...
	return &wallet_go.SetTokenAddressResponse{
		Code: 1,
		Msg:  "set token address success",
	}, nil
}

func validateRequest(request *wallet_go.UnSignTransactionRequest) error {
	if request == nil {
...
func (bws *BusinessMiddleWireServices) StoreDeposits(ctx context.Context,
	depositsRequest *wallet_go.UnSignTransactionRequest, transactionId uuid.UUID, amountBig *big.Int,
...
func (bws *BusinessMiddleWireServices) storeWithdraw(request *wallet_go.UnSignTransactionRequest,
...
func (bws *BusinessMiddleWireServices) storeInternal(request *wallet_go.UnSignTransactionRequest,
	transactionId uuid.UUID, amountBig *big.Int, gasLimit uint64, feeInfo *FeeInfo, transactionType database.TransactionType) error {
